...
class Template(StrEnum):
    ...
    OK_BUTTON = UITemplate.OK_BUTTON
    ...
    CARD_JISTU_EARN_YOUR_BELTS_BUTTON = DojoTemplate.CARD_JISTU_EARN_YOUR_BELTS_BUTTON
    CARD_JITSU_WAITING_FOR_MORE_PLAYERS = DojoTemplate.CARD_JITSU_WAITING_FOR_MORE_PLAYERS

    FIRE_EMBLEM_PLAYER_CARD = DojoTemplate.FIRE_EMBLEM_PLAYER_CARD
    WATER_EMBLEM_PLAYER_CARD = DojoTemplate.WATER_EMBLEM_PLAYER_CARD
    ICE_EMBLEM_PLAYER_CARD = DojoTemplate.ICE_EMBLEM_PLAYER_CARD
    ICE_EMBLEM_PLAYER_CARD_2 = DojoTemplate.ICE_EMBLEM_PLAYER_CARD_2

    FIRE_EMBLEM_SCORE = DojoTemplate.FIRE_EMBLEM_SCORE
    WATER_EMBLEM_SCORE = DojoTemplate.WATER_EMBLEM_SCORE
    ICE_EMBLEM_SCORE = DojoTemplate.ICE_EMBLEM_SCORE
